<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li><a href="">Users Online: <span class="usersonline"></span></a></li>
             ...
             <!--spunon dropdown  si duhet-->
                <li class="dropdown show">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"  id="dns" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-user"></i> <?php echo escape($_SESSION['username']);?><b class="caret"></b></a>
                    <ul class="dropdown-menu" aria-labelledby="dns" >
                        <li>
                ...
                <?php if(is_admin()): ?>
                    ...
                    <li>
                        ...
                        <ul id="posts" class="collapse">
                            ...
                            <li>
                                <a href="ViewPosts.php?source=add_posts">Add Posts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
